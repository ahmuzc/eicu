...
drop table if exists pivoted_vent_part1_eicu;
create table pivoted_vent_part1_eicu as
...
drop table if exists pivoted_vent_part2_eicu;
create table pivoted_vent_part2_eicu as
...
drop table if exists pivoted_vent_part34_eicu;
create table pivoted_vent_part34_eicu as
...
, ventilation_40 as (
	...
	from (select distinct * from ventilation_3 ) as derivedtable
)
...
drop table if exists pivoted_vent_part56_eicu;
create table pivoted_vent_part56_eicu as
...
, ventilation_501 as (
	select *
	, case
	when rn = 2 and vent_flag = 1 and activeupondischarge = 'True' then 1
	else 0 end as flag
	from ventilation_50
)
...
drop table if exists pivoted_vent_eicu;
create table pivoted_vent_eicu as
