...
drop table if exists sepsis_basic_eicu;
create table sepsis_basic_eicu as
...
--
----------------------------------------------------------------------------------------------------------------------------
drop table if exists sepsis_part1_eicu;
create table sepsis_part1_eicu as
...
--
----------------------------------------------------------------------------------------------------------------------------
drop table if exists sepsis_part2_eicu;
create table sepsis_part2_eicu as
...
with sepsis_diagnosis_info_00 as (
    ...
    and patientunitstayid in (select patientunitstayid from sepsis_basic_eicu)
)
...
--
---------------------------------------------------------------------------------------------------------------------
drop table if exists sepsis_part3_eicu;
create table sepsis_part3_eicu as
...
--
---------------------------------------------------------------------------------------------------------------------
drop table if exists sepsis_part4_eicu;
create table sepsis_part4_eicu as
...
drop table if exists sepsis_adult_eicu;
create table sepsis_adult_eicu as

with sepsis_info_eicu as (
  select patientunitstayid
  from sepsis_part1_eicu
  union all
  select patientunitstayid
  from sepsis_part2_eicu
  union all
  select patientunitstayid
  from sepsis_part3_eicu
  union all
  select patientunitstayid
  from sepsis_part4_eicu
)
