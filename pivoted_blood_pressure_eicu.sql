drop table if exists pivoted_blood_pressure_eicu;
create table pivoted_blood_pressure_eicu as
...
, vitala_bp_0 as (
	...
	, round(cast (COALESCE(noninvasivemean, (noninvasivediastolic + (noninvasivesystolic - noninvasivediastolic)/3)) as numeric),0) as mbp
